...
### Effects & DSP
* Added a conventional **Wah** effect alongside the Auto-Wah. Its Pedal Position is made to be mapped to an expression pedal, a MIDI CC or DAW automation, and is smoothed so a MIDI pedal sweeps without zipper noise. Heel and toe frequency, Q and how it narrows across the sweep, pot taper, toe gain, low end, treble, inductor-style saturation and an optical-style response lag cover most wah designs, and 22 factory presets voice popular and boutique pedals — the Cry Baby GCB-95, Vox V847 and Clyde McCoy, Dunlop's signature models, Morley, Weeping Demon, Fulltone Clyde Deluxe, Real McCoy RMC3, Xotic XW-1 and more. Auto-Engage switches the wah off once the pedal rests at the heel, for expression pedals without a toe switch.
