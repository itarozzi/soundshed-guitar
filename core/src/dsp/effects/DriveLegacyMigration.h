...
inline constexpr LevelTable kDistortionLevels = {{
    ...
    {{{-10.4, -4.4, 1.6, 7.6, 13.2}, {-9.5, -3.5, 2.5, 8.4, 13.3}, {-11.1, -5.1, 0.9, 6.4, 10.6}, {-13.9, -7.9, -1.9, 3.5, 7.3}, {-14.7, -8.7, -2.7, 2.7, 6.5}}}, // drive 0.027
    {{{-6.3, -0.3, 5.7, 11.5, 16.5}, {-5.7, 0.3, 6.3, 11.7, 16.1}, {-7.4, -1.4, 4.6, 9.3, 12.8}, {-10.2, -4.2, 1.8, 6.4, 9.1}, {-11.0, -5.0, 1.0, 5.5, 8.3}}}, // drive 0.064
    {{{-1.1, 4.9, 10.9, 16.5, 21.1}, {-0.6, 5.4, 11.4, 16.5, 20.8}, {-2.4, 3.6, 9.6, 13.5, 16.9}, {-5.2, 0.8, 6.8, 10.5, 12.5}, {-6.0, 0.0, 6.0, 9.6, 11.7}}}, // drive 0.118
    {{{1.4, 7.4, 13.4, 18.9, 23.6}, {1.9, 7.9, 13.9, 19.1, 23.7}, {0.1, 6.1, 12.1, 15.5, 19.2}, {-2.7, 3.3, 9.3, 12.1, 13.7}, {-3.6, 2.4, 8.4, 11.2, 12.8}}}, // drive 0.195
    {{{3.2, 9.2, 15.2, 20.9, 24.0}, {3.7, 9.7, 15.8, 21.9, 24.0}, {1.9, 7.9, 13.9, 17.7, 21.7}, {-0.9, 5.1, 11.1, 13.2, 14.6}, {-1.8, 4.2, 10.2, 12.4, 13.7}}}, // drive 0.305
    {{{4.5, 10.5, 16.5, 22.7, 24.0}, {5.0, 11.0, 17.5, 24.0, 24.0}, {3.2, 9.2, 15.7, 20.4, 24.0}, {0.6, 6.6, 12.5, 14.2, 15.7}, {-0.3, 5.7, 11.6, 13.4, 14.6}}}, // drive 0.461
    {{{5.2, 11.2, 17.3, 23.9, 24.0}, {5.8, 11.8, 19.0, 24.0, 24.0}, {4.3, 10.3, 18.1, 24.0, 24.0}, {1.9, 7.9, 13.9, 15.8, 19.4}, {1.1, 7.1, 13.2, 14.9, 16.7}}}, // drive 0.683
    {{{4.9, 10.9, 17.1, 24.0, 24.0}, {6.0, 12.0, 20.8, 24.0, 24.0}, {5.2, 11.2, 24.0, 24.0, 24.0}, {3.3, 9.3, 16.2, 24.0, 24.0}, {2.7, 8.7, 15.3, 24.0, 24.0}}}, // drive 1.000
}};

/// Old Fuzz onto the Fuzz Face.
inline constexpr LevelTable kFuzzLevels = {{
    {{{-22.3, -16.3, -10.3, -4.3, 1.7}, {-15.7, -9.7, -3.7, 2.3, 8.0}, {-13.7, -7.7, -1.7, 4.3, 9.6}, {-15.4, -9.4, -3.4, 2.6, 7.8}, {-17.9, -11.9, -5.9, 0.1, 5.2}}}, // drive 0.000
    {{{-18.8, -12.8, -6.8, -0.8, 5.0}, {-12.1, -6.1, -0.1, 5.9, 10.6}, {-10.0, -4.0, 2.0, 7.8, 11.7}, {-11.6, -5.6, 0.4, 6.1, 9.9}, {-14.2, -8.2, -2.2, 3.5, 7.3}}}, // drive 0.027
    {{{-15.5, -9.5, -3.5, 2.5, 7.4}, {-8.7, -2.7, 3.3, 9.0, 12.5}, {-6.6, -0.6, 5.4, 10.4, 13.2}, {-8.3, -2.3, 3.7, 8.6, 11.5}, {-10.8, -4.8, 1.2, 6.0, 9.1}}}, // drive 0.064
    {{{-12.6, -6.6, -0.6, 5.2, 9.2}, {-5.9, 0.1, 6.1, 11.2, 14.0}, {-3.8, 2.2, 8.2, 12.2, 14.3}, {-5.5, 0.5, 6.5, 10.4, 12.8}, {-8.0, -2.0, 4.0, 7.9, 10.6}}}, // drive 0.118
    {{{-10.6, -4.6, 1.4, 6.9, 10.3}, {-3.9, 2.1, 8.1, 12.6, 15.2}, {-1.9, 4.1, 10.1, 13.4, 15.2}, {-3.5, 2.5, 8.4, 11.7, 13.8}, {-6.1, -0.1, 5.8, 9.3, 11.9}}}, // drive 0.195
    {{{-9.4, -3.4, 2.6, 8.0, 11.1}, {-2.6, 3.4, 9.4, 13.6, 16.0}, {-0.6, 5.4, 11.3, 14.2, 15.7}, {-2.3, 3.7, 9.6, 12.6, 14.5}, {-4.9, 1.1, 7.0, 10.3, 12.8}}}, // drive 0.305
    {{{-8.8, -2.8, 3.2, 8.4, 11.4}, {-2.1, 3.9, 9.9, 13.9, 16.2}, {-0.1, 5.9, 11.9, 14.5, 15.8}, {-1.8, 4.2, 10.1, 12.8, 14.6}, {-4.4, 1.6, 7.5, 10.6, 13.0}}}, // drive 0.461
    {{{-9.5, -3.5, 2.5, 8.0, 11.2}, {-2.7, 3.3, 9.3, 13.5, 15.6}, {-0.7, 5.3, 11.2, 14.1, 15.4}, {-2.5, 3.5, 9.5, 12.3, 13.9}, {-5.0, 1.0, 6.9, 9.9, 12.0}}}, // drive 0.683
    {{{-13.6, -7.6, -1.6, 3.6, 6.1}, {-6.6, -0.6, 5.4, 8.5, 10.2}, {-4.4, 1.6, 7.4, 9.4, 11.1}, {-6.2, -0.2, 5.6, 7.6, 9.3}, {-8.7, -2.7, 3.0, 4.9, 6.7}}}, // drive 1.000
}};
// *INDENT-ON*
// clang-format on
